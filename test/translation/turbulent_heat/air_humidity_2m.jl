...
FT = Float64
input_vars, output_vars = load_matlab_data("turbulent_heat_function.AirHumidity2m.json")
...
@testset "AirHumidity2m" begin
    DEi = air_humidity_2m(
        ...
        FT(input_vars["Eimp"]),
        FT(input_vars["Ebare"]),
        FT(input_vars["Eveg_int"]),
        FT(input_vars["Eveg_pond"]),
