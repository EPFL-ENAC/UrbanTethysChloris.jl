...
# Arguments
- `XY1::Matrix{<:Real}`: N1×4 matrix where each row is [x1 y1 x2 y2] representing a line segment
- `XY2::Matrix{<:Real}`: N2×4 matrix where each row is [x1 y1 x2 y2] representing a line segment
