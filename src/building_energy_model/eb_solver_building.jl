...
function eb_solver_building(
    ...
    if AC_on
        ...
        WasteHeat = (;
            ...
            LatentFromAC_Can=LE_AC_Heat * Wroof/Wcan,  # [W/m²] canyon ground
    ...
    elseif Heat_on
        ...
        WasteHeat = (
            ...
            TotAnthInput_URB=(Hequip + Hpeople + LEequip + LEpeople) * Wroof/(Wcan + Wroof),
        )
    ...
    if !BEM_on
        WasteHeat = (;
            ...
            SensibleFromHeat_Can=zero(FT),  # [W/m²] canyon ground
            LatentFromHeat_Can=zero(FT),    # [W/m²] canyon ground
            SensibleFromVent_Can=zero(FT),  # [W/m²] canyon ground
            LatentFromVent_Can=zero(FT),    # [W/m²] canyon ground
            TotAnthInput_URB=zero(FT),      # [W/m²] urban area
        )
