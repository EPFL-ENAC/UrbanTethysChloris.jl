...
3. Add this repo as a remote:
   ...
   ```bash
   git remote add upstream https://github.com/EPFL-ENAC/UrbanTethysChloris.jl
   ```
...
- After that runs, the [stable docs](https://EPFL-ENAC.github.io/UrbanTethysChloris.jl/stable) should be updated. Check them and look for the version number.
